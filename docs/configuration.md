...
FM_SIGNAL_GRACE=30      # seconds to coalesce nearby status and turn-end signals into one wake; the wait ends early once every signaled status file's task turn-end has also landed
